                                ...
                                <div class="flex-1 h-0 overflow-y-auto">
                                    <div class="py-6 px-4 bg-gray-500 sm:px-6">
                                        <div class="flex items-center justify-between">
                                            <DialogTitle class="text-lg font-medium text-white"> Detalle Sector
                                            </DialogTitle>
                                    ...
                                    <div class="flex-1 flex flex-col justify-between">
                                        <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                            ...
                                            <div class="space-y-2 pt-2 pb-5">
                                                <div>
                                                    <label for="time"
                                                        class="block text-lg font-medium text-gray-700 "><b>Sector:
                                                            {{ data.name }}</b></label>
                                                </div>
                                                <hr>
                                                ...
                                                <div>
                                                    <label for="time"
                                                        class="block text-xl font-medium text-gray-800">Usuarios
                                                        Relacionadas</label>
                                                </div>
                                                <hr>
                                                <ul
                                                    class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                                                    <li class="flex items-center" v-for="c in data.users" :key="c.id">
                                                        <svg class="mr-2 w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0"
                                                ...
                                                <!-- <div v-for="c in data.users" :key="c.id"
                                                    ...
                                                    <Icons class="h-5 w-5 mr-1" name="badge-check" /> {{ c.name
                                                    }}
                                                </div> -->
                                            </div>
                                        </div>
