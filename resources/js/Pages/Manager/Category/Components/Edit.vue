                                ...
                                <div class="flex-1 h-0 overflow-y-auto">
                                    <div class="py-6 px-4 bg-gray-500 sm:px-6">
                                        <div class="flex items-center justify-between">
                                            <DialogTitle class="text-lg font-medium text-white"> Editar Categoria
                                            </DialogTitle>
                                        ...
                                        <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                            ...
                                            <div class="space-y-6 pt-6 pb-5">
                                                <div>
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" v-model="form.title" name="title" id="titulo"
                                                            class="block w-full shadow-sm sm:text-sm rounded-md"
                                                            :class="this.errors.title ? 'focus:border-red-500 border-red-300 focus:ring-red-500' : 'focus:border-indigo-500 border-gray-300 focus:ring-indigo-500'" />
                                                        <span v-if="this.errors.title" class="text-xs text-red-500">{{
                                                            this.errors.title[0] ?? '' }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-1">
                                                        <textarea type="text" name="descripcion" id="descripcion"
                                                            ...
                                                            class="block w-full shadow-sm sm:text-sm rounded-md"
                                                            :class="this.errors.description ? 'focus:border-red-500 border-red-300 focus:ring-red-500' : 'focus:border-indigo-500 border-gray-300 focus:ring-indigo-500'"></textarea>
                                                            <span v-if="this.errors.description" class="text-xs text-red-500">{{
                                                            this.errors.description[0] ?? '' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    methods: {
        async store() {
            let data = {}
            try {
                let rt = route('category.update', this.form.id);
