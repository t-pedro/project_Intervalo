                                ...
                                <div class="flex-1 h-0 overflow-y-auto">
                                    <div class="py-6 px-4 bg-gray-500 sm:px-6">
                                        <div class="flex items-center justify-between">
                                            <DialogTitle class="text-lg font-medium text-white"> Detalle Categoria
                                            </DialogTitle>
                                    ...
                                    <div class="flex-1 flex flex-col justify-between">
                                        <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                            ...
                                            <div class="space-y-2 pt-2 pb-5">
                                                    <div>
                                                        <label for="time"
                                                            class="block text-lg font-medium text-gray-700 "><b>Categoria: {{ data.title }}</b></label>
                                                    </div>
                                                    <hr>
                                                    <div class="flex text-sm text-gray-700">
                                                        <label class="text-bold w-24 font-bold">Descripción:</label>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <label for="time"
                                                            class="block text-xl font-medium text-gray-800">Competencias Relacionadas</label>
                                                    </div>
                                                    <hr>

                                                    <div v-for="c in data.competencias" :key="c.id" class="inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10 mr-2">
