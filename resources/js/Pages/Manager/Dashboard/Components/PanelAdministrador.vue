            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    <div class="flex items-center justify-between flex-wrap sm:flex-nowrap ">
                        <div class="flex">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Dashboard | Administrador</h3>
                        </div>
                            ...
                            <div class="px-4 sm:px-0">
                                ...
                                <ul role="list"
                                    ...
                                    <li class="relative col-span-1 flex shadow-sm rounded-md">
                                        <div
                                            class="flex-shrink-0 flex items-center justify-center w-16 text-white text-sm font-medium rounded-l-md bg-red-500">
                                            EA
                                        </div>
                                        <div
                                            ...
                                            <div class="flex flex-col px-4 py-2 text-sm truncate">
                                                <a href="#" class="text-gray-900 font-medium hover:text-gray-600">
                                                    <b>EMPRESAS ACTIVAS</b>
                                                </a>
                                                <p class="text-gray-400 mt-1 text-gray-700 text-lg">
                                                    {{ data.total_companie }}</p>
                                                <a :href="route('companie')"
                                                    class="mt-1 text-gray-500 hover:underline hover:text-gray-700">Ver
                                                    Empresas</a>
                                            </div>
                                        </div>
                                    </li>
