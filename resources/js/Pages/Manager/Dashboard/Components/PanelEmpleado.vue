                                    ...
                                    <li class="relative col-span-1 flex shadow-sm rounded-md">
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col px-4 py-2 text-sm truncate">
                                                ...
                                                <p class="text-gray-400 mt-1 text-gray-700 text-lg">
                                                    {{ validarNumero(((test_details.finish / test_details.total) * 100).toFixed(2)) }}%
                                                </p>
                                                <!-- <a :href="route('test')" class="mt-1 text-gray-500 hover:underline hover:text-gray-700">Ver Examenes</a> -->
                                                -
                                            </div>
                                    ...
                                    <li class="relative col-span-1 flex shadow-sm rounded-md">
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col px-4 py-2 text-sm truncate">
                                                ...
                                                <p class="text-gray-400 mt-1 text-gray-700 text-lg">
                                                    {{ validarNumero(((test_details.abandoned / test_details.total) * 100).toFixed(2)) }}%
                                                </p>
                                                <!-- <a :href="route('test')" class="mt-1 text-gray-500 hover:underline hover:text-gray-700">Ver Examenes</a> -->
                                                -
                                            </div>
                                    ...
                                    <li class="relative col-span-1 flex shadow-sm rounded-md">
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col px-4 py-2 text-sm truncate">
                                                ...
                                                <p class="text-gray-400 mt-1 text-gray-700 text-lg">
                                                    {{ validarNumero(((test_diagnostico_details.finish / test_diagnostico_details.total) * 100).toFixed(2)) }}%
                                                </p>
                                                <!-- <a :href="route('test')" class="mt-1 text-gray-500 hover:underline hover:text-gray-700">Ver Examenes</a> -->
                                                -
                                            </div>
                                    ...
                                    <li class="relative col-span-1 flex shadow-sm rounded-md">
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col px-4 py-2 text-sm truncate">
                                                ...
                                                <p class="text-gray-400 mt-1 text-gray-700 text-lg">
                                                    {{ validarNumero(((test_diagnostico_details.abandoned / test_diagnostico_details.total) * 100).toFixed(2)) }}%
                                                </p>
                                                <!-- <a :href="route('test')" class="mt-1 text-gray-500 hover:underline hover:text-gray-700">Ver Examenes</a> -->
                                                -
                                            </div>
                            ...
                            <li class="relative col-span-1 flex shadow-sm rounded-md">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col px-4 py-2 text-sm truncate">
                                        ...
                                        <p class="text-gray-400 mt-1 text-gray-700 text-lg">
                                            {{ validarNumero(((test_total_details.approbe / test_total_details.total_test_score) * 100).toFixed(2)) }}%
                                        </p>
                                        <!-- <a :href="route('test')" class="mt-1 text-gray-500 hover:underline hover:text-gray-700">Ver Examenes</a> -->
                                        -
                                    </div>
                            ...
                            <li class="relative col-span-1 flex shadow-sm rounded-md">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col px-4 py-2 text-sm truncate">
                                        ...
                                        <p class="text-gray-400 mt-1 text-gray-700 text-lg">
                                            {{ validarNumero(((test_total_details.disapprobe / test_total_details.total_test_score) * 100).toFixed(2)) }}%
                                        </p>
                                        <!-- <a :href="route('test')" class="mt-1 text-gray-500 hover:underline hover:text-gray-700">Ver Examenes</a> -->
                                        -
                                    </div>
